# [Max and Min Product from 2 Arrays](https://www.geeksforgeeks.org/problems/product-of-maximum-in-first-array-and-minimum-in-second3943/1?page=2&category=Arrays,Java&difficulty=Basic&status=unsolved&sortBy=submissions)
## Easy

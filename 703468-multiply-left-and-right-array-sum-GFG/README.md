# [Multiply left and right array sum](https://www.geeksforgeeks.org/problems/multiply-left-and-right-array-sum1555/1?page=1&category=Arrays,Java&difficulty=Basic&status=unsolved&sortBy=submissions)
## Easy
...
Input : arr = [1, 2] 
Output :  2 Explanation: Their multiplication is 1*2 is equal to 2.
Expected Time Complexity: O(n).Expected Auxiliary Space:&nbsp;O(1).
Constraints:1 ≤ arr.size() ≤ 10001 ≤ arr[i] ≤ 100